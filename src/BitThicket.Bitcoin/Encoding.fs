...
module Encoding =
    ...
    type EncodedString =
        | Base58String of Base58String
        | Base58CheckString of Base58CheckString

    // type Encoding =
        // | BitcoinAddress of EncodingData
    ...
    // let inline internal toBytePrefix encoding =
    //     match encoding with
    //     | BitcoinAddress -> [|0x00uy|]  // 1; also P2PKH
        // | P2SH -> [|0x05uy|]   // 3
        // | WIF -> [|0x80uy|]    // 5
    ...
    // let internal encodeUnchecked encoding payload =
    //     Array.concat [ toBytePrefix encoding; payload ]

    // /// Encodes a payload with a prefix b
    // let inline internal toEncoding (encodedString:EncodedString) (payload:byte array) =
