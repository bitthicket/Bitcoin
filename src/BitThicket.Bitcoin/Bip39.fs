namespace BitThicket.Bitcoin.Bips

#nowarn "3391" // disable warning about implicit conversion for byte[] -> ReadOnlySpan<byte>
            ...
            | Ok entropy ->
                ...
                seq {
                    for i in 0..length-1 do
                        ...
                        let word = Array.get wordlist index
                        yield word
                } |> Ok

    let private wordlist = [|
        "abandon"
        "ability"
        "able"
        "about"
